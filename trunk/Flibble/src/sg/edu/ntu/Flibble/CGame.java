 ...
 public class CGame extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals((String) "CGame") && userId != null && userId.equals("")!=true){
		...
		else if(action.equals((String) "DGame") && userId != null && userId.equals("")!=true){
			if(gname!=null && gname.equals("")!=true){
				room.DelGame(gname);
				retFlag = true;
			}
		}
		else if(action.equals((String) "JoinIn") && userId != null && userId.equals("")!=true){
			if(gname!=null && gname.equals("")!=true){
				retFlag = room.JoinGame(gname, userId);
			}
		}
		else if(action.equals((String) "Query") && userId != null && userId.equals("")!=true){
			retFlag = true;
		}
